...
if (!isset($_REQUEST['id'])) {
    header('Location: examenraven.php');
}
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <body>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Examén Raven</h1>
                </div>
            </div>
            <?php if($_REQUEST['id'] == 0){?>
            <div class="container-fluid">
                <h2>Agregar Examén Raven</h2>
                <form id="frmCreate" method="post">
                    ...
                    <div class="form-group">
                        <label>Puntaje</label>
                        <input class="form-control" name="txtPuntaje" required>
                    </div>
                    <div class="form-group">
                        <label>Comentarios</label>
                        <textarea class="form-control" name="txtComentarios" required>
                        </textarea>
                    </div>
            ...
            <div class="container-fluid">
                <h2>Actualizar Examén Raven</h2>
                <?php
                $query = "SELECT * FROM alumno NATURAL JOIN examen_raven WHERE id_examen_raven = ".$_REQUEST['id'];
                ...
                <form id="frmUpdate" method="post">
                    ...
                    <div class="form-group">
                        <label>Puntaje</label>
                        <input class="form-control" name="txtPuntaje" value="<?php echo $puntaje ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Comentarios</label>
                        <textarea class="form-control" name="txtComentarios" required><?php echo $comentarios ?></textarea>
                    </div>
        ...
        <script src="js/examenraven.js"></script>
