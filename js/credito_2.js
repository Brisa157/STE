...
//JavaScript (JQuery: Ligado con CSS  y Ajax: Enviar Peticion Al servidor: Agrega, Actualiza y Busca)
$('#frmCreate').on('submit', function () {
    $.ajax({
        url: "procesos/proceso_credito_2.php?opt=1", 
        type: "POST", 
        ...
        success: function (resp) {
            if (resp === "CORRECTO") {
                correctoAlertaLocation("credito_2.php");
            } else if (resp === "ERROR") {
