...
<html lang="es">
    ...
    <body>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Servicio Social</h1>
                </div>
            </div>
            <div class="container-fluid">
                <a class="btn btn-default" href="serviciosocial_add_edit.php?id=0">Nuevo</a>
                <br><br>
                <div class="table-responsive">
                    <table id="tblData"  class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM alumno NATURAL JOIN servicio_social";
                            $result = mysqli_query($con, $query);
                            if ($result) {
                                foreach ($result as $data) {
                                    $data['acciones'] = '<a class="btn btn-info" href="serviciosocial_add_edit.php?id='.$data['id_servicio_social'].'">Actualizar</a>';
                                    $numero_control = $data['numero_control'];
                                    $nombre_completo = $data['nombre_completo'];
                                    $semestre = $data['semestre'];
                                    $fecha_liberacion = $data['fecha_liberacion'] != '' ? $data['fecha_liberacion']:'En curso';
                                    $acciones = $data['acciones'];
                                    echo "<tr>
                                <td>$numero_control</td>
                                <td>$nombre_completo</td>
                                <td>$semestre</td>
                                <td>$fecha_liberacion</td>
                                <td>$acciones</td>
                                </tr>";
                                }
                            }
        ...
        <script src="js/serviciosocial.js"></script>
