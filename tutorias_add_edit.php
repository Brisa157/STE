...
if (!isset($_REQUEST['id'])) {
    header('Location: serviciosocial.php');
}
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Tutorias</h1>
                </div>
            </div>
            <?php if ($_REQUEST['id'] == 0) { ?>
            <div class="container-fluid">
                <h2>Registrar Tutoria</h2>
                <form id="frmCreate" method="post">
                    ...
                    <div class="form-group">
                        <label>Tutor</label>
                        <input type="text" class="form-control" name="txtTutor" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="container-fluid">
                <?php
                $query = "SELECT numero_control, nombre_completo, tutor, tutoria.id_periodo, tutoria.semestre FROM alumno INNER JOIN tutoria ON alumno.id_alumno = tutoria.id_alumno WHERE id_tutoria = ".$_REQUEST['id'];
                $result = mysqli_query($con, $query);
                if ($result) {
                    foreach ($result as $data) {
                ...
                <form id="frmUpdate" method="post">
                    ...
                    <div class="form-group">
                        <label>Tutor</label>
                        <input type="text" class="form-control" value="<?php echo $tutor ?>" name="txtTutor" required>
                    </div>
                    <div class="form-group">
                        <label>Semestre</label>
