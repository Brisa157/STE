        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container-fluid">
                ...
                <form id="frmCreate" method="post">
                    ...
                    <div class="form-group">
                        <label>Asesor</label>
                        <input type="text" class="form-control" name="txtAsesor" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="container-fluid">
                <h2>Actualizar Servicio Social</h2>
                <?php
                $query = "SELECT * FROM alumno NATURAL JOIN servicio_social WHERE id_servicio_social = ".$_REQUEST['id'];
                ...
                <form id="frmUpdate" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="txtAsesor" value="<?php echo $asesor ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Fecha Inicio</label>
