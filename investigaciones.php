    ...
    <body>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container-fluid">
                <a class="btn btn-default" href="investigaciones_add_edit.php?id=0">Nuevo</a>
                <br><br>
                <div class="table-responsive">
                    <table id="tblData"  class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM alumno NATURAL JOIN investigacion NATURAL JOIN carrera";
                            $result = mysqli_query($con, $query);
                            if ($result) {
                                foreach ($result as $data) {
                                    $data['acciones'] = '<a class="btn btn-info" href="investigaciones_add_edit.php?id='.$data['id_investigacion'].'">Actualizar</a>';
