...
if (DatabaseConnect::isConnected()) {
    switch ($opt) {
        case 1:
            ...
            $query = "INSERT INTO ingles(examen_ubicacion, curso_nivelacion, calificacion_curso_nivelacion,semestre,id_alumno) VALUES(0,1,$calificacion, $semestre, $id_alumno)";
        ...
        case 2:
            ...
            $query = "UPDATE ingles SET semestre = $semestre, calificacion_curso_nivelacion = $calificacion WHERE id_ingles = $id";
