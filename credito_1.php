...
<html lang="es">
    ...
    <body>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Credito 1</h1>
                </div>
            </div>
            <div class="container-fluid">
                <a class="btn btn-default" href="credito_1_add_edit.php?id=0">Nuevo</a>
                <br><br>
                <div class="table-responsive">
                    <table id="tblData"  class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM alumno NATURAL JOIN credito NATURAL JOIN carrera WHERE tipo_credito =1";
        ...
        <script src="js/credito_1.js"></script>
