        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Semanas Académicas</h1>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <form id="frmCreate" method="post">
                    ...
                    <div class="form-group">
                        <label>Telefono Del Padre/Tutor</label>
                        <input type="text" class="form-control campoNumero" name="txtTelefonoTutor" required>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <?php
                $query = "SELECT telefono_tutor, is_firmado, numero_control, nombre_completo, semana_academica.semestre, fecha_salida, fecha_regreso FROM alumno INNER JOIN semana_academica ON alumno.id_alumno = semana_academica.id_alumno WHERE id_semana_academica = ".$_REQUEST['id'];
                ...
                <form id="frmUpdate" method="post">
                    ...
                    <div class="form-group">
                        <label>Telefono Del Padre/Tutor</label>
                        <input type="text" class="form-control campoNumero" value="<?php echo $telefono_tutor ?>" name="txtTelefonoTutor" required>
                    </div>
                    <div class="form-group">
                            <label>Autorizado</label>
                            <label class="radio-inline"><input type="radio" value="1" name="rbtnFirmado" required <?php echo $firmado == 1 ? "checked":""; ?>>Si</label>
                            <label class="radio-inline"><input type="radio" value="0" name="rbtnFirmado" required <?php echo $firmado == 0 ? "checked":""; ?>>No</label>
                        </div>
