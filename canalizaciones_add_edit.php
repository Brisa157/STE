...
<html lang="es">
    ...
    <body>
        ...
        <?php include './include/nav.php'; ?>
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Canalizaciones</h1>
                </div>
            </div>
            <?php if ($_REQUEST['id'] == 0) { ?>
            <div class="container-fluid">
                <h2>Iniciar Canalización</h2>
            ...
            <div class="container-fluid">
                <h2>Actualizar Canalización</h2>
                <?php
                $query = "SELECT * FROM alumno NATURAL JOIN canalizacion NATURAL JOIN carrera WHERE id_canalizacion =".$_REQUEST['id'];
                ...
                <form id="frmUpdate" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="txtFechaFinal" value="<?php echo $fecha_final ?>">
                    </div>
        ...
        <script src="js/canalizaciones.js"></script>
