        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Tutorías</h1>
                </div>
            </div>
            <div class="container-fluid">
                <a class="btn btn-default" href="tutorias_add_edit.php?id=0">Nuevo</a>
                <br><br>
                <div class="table-responsive">
                    <table id="tblData"  class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM alumno INNER JOIN tutoria ON alumno.id_alumno = tutoria.id_alumno";
                            $result = mysqli_query($con, $query);
                            if ($result) {
                                foreach ($result as $data) {
                                    $data['acciones'] = '<a class="btn btn-info" href="tutorias_add_edit.php?id='.$data['id_tutoria'].'">Actualizar</a>';
